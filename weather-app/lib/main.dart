...
import 'package:meteo/helper/myicons.dart';
import 'package:meteo/cubit/weathercubit.dart';
...
Future<WeatherModel> downloadData() async {
  ...
  return Network.getWeatherForecastData(cityName: "Montpellier");
}
              ...
              return SafeArea(
                child: Padding(
                  ...
                  child: Scaffold(
                    appBar: AppBar(
                      ...
                      title: TextField(
                        ...
                        onSubmitted: (value)async {
                         await context.read<WeatherCubit>().doSearch(search);
                          setState(() {
                            loading=false;
                          });
                        },
                    ...
                    body:  BlocBuilder<WeatherCubit, WeatherModel>(
